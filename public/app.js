    ...
    saveBtn.on('click', async (e) => {
      ...
      try {
        const response = await $.ajax({
          url: 'https://mypcbuild-com.onrender.com/api/create-list',
          type: 'PUT',
...
async function getAllData() {
  try{
    const response = await $.ajax({
      url: 'https://mypcbuild-com.onrender.com/api/ALL',
      type: 'GET'
    })
    partsData = response
...
function signInWindow () {
  ...
  existingProfileBtn.on('click', async (e) => {
    ...
    try {
      const response = await $.ajax({
        url: 'https://mypcbuild-com.onrender.com/api/sign-in',
        type: 'POST',
        contentType: 'application/json',
        data: JSON.stringify(userData),
      })
  ...
  newUserBtn.on('click', async (e) => {
    ...
    try {
      const response = await $.ajax({
        url: 'https://mypcbuild-com.onrender.com/api/create-user',
        type: 'POST',
        contentType: 'application/json',
        data: JSON.stringify(userData),
      })
...
function generateUserPage () {
  ...
  viewListsBtn.on('click', async (e) => {
    try{
      const response = await $.ajax({
        url: `https://mypcbuild-com.onrender.com/api/user-builds/${loggedId}`,
        type: 'GET',
      })
...
async function generateBuild(build) {
  ...
  deleteBtn.on('click', async (e) => {
    ...
    try{
      const response = await $.ajax({
          url: `https://mypcbuild-com.onrender.com/api/delete-build`,
          type: 'DELETE',
          contentType: 'application/json',
          data: JSON.stringify(userData),
    })
